...
namespace KMO.Rpt {
    ...
    public class rptINV_PAK_3 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "KMO.Rpt.rptINV-PAK-3.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptINV_PAK_3 : Component, ICachedReport {
        
        public CachedrptINV_PAK_3() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptINV_PAK_3 rpt = new rptINV_PAK_3();
            rpt.Site = this.Site;
            return rpt;
        }
