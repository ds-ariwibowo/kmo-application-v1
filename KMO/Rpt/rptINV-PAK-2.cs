...
namespace KMO.Rpt {
    ...
    public class rptINV_PAK_2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "KMO.Rpt.rptINV-PAK-2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptINV_PAK_2 : Component, ICachedReport {
        
        public CachedrptINV_PAK_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptINV_PAK_2 rpt = new rptINV_PAK_2();
            rpt.Site = this.Site;
            return rpt;
        }
