...
namespace KMO.Rpt {
    ...
    public class rptINV_PAK_4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "KMO.Rpt.rptINV-PAK-4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptINV_PAK_4 : Component, ICachedReport {
        
        public CachedrptINV_PAK_4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptINV_PAK_4 rpt = new rptINV_PAK_4();
            rpt.Site = this.Site;
            return rpt;
        }
