...
namespace KMO.Rpt {
    ...
    public class rptCOP_PLNA4_6 : ReportClass {
        
        public rptCOP_PLNA4_6() {
        }
        
        public override string ResourceName {
            get {
                return "rptCOP-PLNA4-6.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "KMO.Rpt.rptCOP-PLNA4-6.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptCOP_PLNA4_6 : Component, ICachedReport {
        
        public CachedrptCOP_PLNA4_6() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptCOP_PLNA4_6 rpt = new rptCOP_PLNA4_6();
            rpt.Site = this.Site;
            return rpt;
        }
