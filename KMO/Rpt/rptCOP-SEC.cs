...
namespace KMO.Rpt {
    ...
    public class rptCOP_SEC : ReportClass {
    ...
    public class CachedrptCOP_SEC : Component, ICachedReport {
        
        public CachedrptCOP_SEC() {
        }
