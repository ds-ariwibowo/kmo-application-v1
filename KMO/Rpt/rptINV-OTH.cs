...
namespace KMO.Rpt {
    ...
    public class rptINV_OTH : ReportClass {
    ...
    public class CachedrptINV_OTH : Component, ICachedReport {
        
        public CachedrptINV_OTH() {
        }
