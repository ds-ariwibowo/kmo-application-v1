...
namespace KMO.Setup
{
    public partial class CFS : System.Web.UI.Page
    {
        DataTable dt;
        DataSet ds;
        Boolean bRes;
        ...
        private Boolean checkData()
        {
            ...
            try
            {
                ...
                if (txtAddress.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Company address is empty."); }
                if (txtCity.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "City name is empty."); }
                if (txtZIP.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Zip is empty."); }
                if (txtTelp.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Telp is empty."); }
                ...
                if (txtProsTelpLineCharge.Text.Trim() == "") { txtProsTelpLineCharge.Text="3000000"; }
                if (txtFittingOutDate.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Fitting out date is empty."); }
                ...
                if (!bEdit)
                {
                    ...
                    if (txtMemorandumExpiredDate.Text.Trim() == "") { txtMemorandumExpiredDate.Text = "01-01-1900"; }
                ...
                if (ddlRentPeriod.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Rent period is empty."); }
                if (txtRentCharge.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Rent charge is empty."); }
                if (txtServiceCharge.Text.Trim() == "") { iRes = false; showMessage(eMessage.eWarning, "Data empty", "Service charge is empty."); }
