...
namespace KMO
{
    public partial class RentService : System.Web.UI.Page
    {
        DataTable dt;
        DataSet ds;
        Boolean bRes;
        ...
        private Boolean checkDataRecord(string iMon, string iYear, string iSuite, string iInvID)
        {
            ...
            ds = Db.get_list("Select * From tCOP_RAS_Payment Where Status = 1 And InvID = " + iInvID);
                                    ...
                                    string iPeriodFrom, string iPeriodTo, string iInvSource)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@InvSource", "RAS");
        ...
        private void getData(string iID, string iSuiteNo)
        {
            try
            {
                ds = Db.get_list("select * from mCFSSuite where Status = 1 and CFSid = " + iID + " And SuiteNo = " + iSuiteNo + " order by id desc");
                ...
                long iSubTotal = iRentalAmount + iServiceAmount + iOtherAmount;
                long iPPn = Convert.ToInt64(String.Format("{0:0}", (iSubTotal) * (0.1)));
                ...
                string iSql = "select Top 1 *, " +
                          ...
                          "where InvSource = 'ras' And Status = 1 And CFSid = " + iID + " And SuiteNo = " + iSuiteNo + " " +
                          "Order By InvNo Desc";
                ds = Db.get_list(iSql);
        ...
        private void BindGrid(string iCFSID, string iSuiteNo)
        {
            string iSql = "Select Distinct ID, Month, Year, InvNo, PrintDate, " +
                          ...
                          "where InvSource = 'ras' And Status = 1 And CFSid = " + iCFSID + " And SuiteNo = " + iSuiteNo + " " + 
                          "Order By InvNo Desc";
            try
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                executeAdd(txtCompanyID.Text, txtFloor.Text, txtSuiteNo.Text, txtRentArea.Text, txtKVA.Text,
                            ...
                            txtParkingOtherPeriod.Text, txtParkingOtherPeriodMY.Text, txtParkingOtherCharge.Text, iPeriodFromDate.ToString(), iPeriodToDate.ToString(), "RAS");             
            }           
