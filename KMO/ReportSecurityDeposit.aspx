<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="ReportSecurityDeposit.aspx.cs" Inherits="KMO.ReportSecurityDeposit" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">
        <div class="row col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>Invoice Security Deposit</h4></div>
            <div class="row" >
            ...
            <ContentTemplate>                    
                <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center"
                    ...
                    <asp:ButtonField CommandName="printRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                        ...
                        ButtonType="Button" Text="Print" HeaderText ="Print INV:SEC" 
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <strong><asp:Label ID="Label1" runat="server">Print SEC Invoice</asp:Label></strong>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="row" >
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-2">&nbsp</div>
                                        <div class="col-xs-12 col-sm-6">                                            
                                            <asp:TextBox ID="txtPhoneLine" runat="server"  placeholder="" Width="40px" OnTextChanged="txtCalculate_TextChanged" AutoPostBack="true"></asp:TextBox> phone line x Rp.
                                            <asp:TextBox ID="txtPhoneLineCharge" runat="server"  placeholder="" Width="60px" OnTextChanged="txtCalculate_TextChanged" AutoPostBack="true"></asp:TextBox>
