<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="SecurityDeposit.aspx.cs" Inherits="KMO.SecurityDeposit" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">
        <div class="row col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>Security Deposit</h4></div>
            <div class="col-xs-12 col-sm-12" style="padding:0 5 0 0;" >
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <asp:Label ID="lblProsTelpLine" runat="server">xxxxxx</asp:Label> x Rp. 
                        <asp:Label ID="lblProsTelpLineCharge" runat="server">xxxxxx</asp:Label>
                    </div>
                    <div class="col-xs-12 col-sm-2" style="text-align:right"><asp:Label ID="lblProsTelpLineAmount" runat="server">xxxxxx</asp:Label></div>
                </div>
                <div class="row">&nbsp</div>
                <div class="row">
