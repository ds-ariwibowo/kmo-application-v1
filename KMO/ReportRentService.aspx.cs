...
namespace KMO
{
    public partial class ReportRentService : System.Web.UI.Page
    {
        DataTable dt;
        DataSet ds;
        Boolean bRes;
        ...
        private void calculate(string kode, int awal)
        {
            ...
            if (awal == 1)
            {
                ...
                iRentalArea = Convert.ToDecimal(ds.Tables[0].Rows[0]["RentalArea"].ToString());
                iRentalPeriod = Convert.ToDecimal(ds.Tables[0].Rows[0]["RentalPeriod"].ToString());
                iRentalCharge = Convert.ToInt64(ds.Tables[0].Rows[0]["RentalCharge"].ToString());
                

                iServiceArea = Convert.ToDecimal(ds.Tables[0].Rows[0]["ServiceArea"].ToString());
                iServicePeriod = Convert.ToDecimal(ds.Tables[0].Rows[0]["ServicePeriod"].ToString());
                iServiceCharge = Convert.ToInt64(ds.Tables[0].Rows[0]["ServiceCharge"].ToString());


                iOtherArea = Convert.ToDecimal(ds.Tables[0].Rows[0]["OtherArea"].ToString());
                iOtherPeriod = Convert.ToDecimal(ds.Tables[0].Rows[0]["OtherPeriod"].ToString());
                iOtherCharge = Convert.ToInt64(ds.Tables[0].Rows[0]["OtherCharge"].ToString());
            }
            else
            {
                decimal dVal;
                ...
                iRentalCharge = Convert.ToInt64(Convert.ToInt64(ds.Tables[0].Rows[0]["RentalCharge"].ToString()));
            ...
            iSubTotal = iRentalAmount + iServiceAmount + iOtherAmount;
            iPPn = Convert.ToInt64(String.Format("{0:0}", (iSubTotal) * (0.1)));
            ...
            lblOtherPeriodMY.Text = ds.Tables[0].Rows[0]["RentalPeriodMY"].ToString();
        ...
        {
            string iSql = "execute [spGetInvoiceSourceMY_Query] 'ras', " + ddlMonthPeriod.Text + ", " + txtYearPeriod.Text + " ";
            try
            {
        ...
        {
            string iSql = "Select Distinct * from vwInvoiceSource_All Where InvSource= 'RAS'  and Month = " + ddlMonthPeriod.Text + " and year = " + txtYearPeriod.Text + " Order By " + iOrderBy;
        ...
        private void CreateDynamicGrid(string iOrderBy)
        {
            ...
            {
                string iQuery;
                iQuery = "Select Distinct * from vwInvList_RAS_All Where Month = " + ddlMonthPeriod.Text + " and year = " + txtYearPeriod.Text + " Order By " + iOrderBy;
        ...
        protected void previewInvoice(string iMonth, string iYear, string iSuiteNo, string iID)
        {
            //loadRPT();            

            try
            {
                String SQL = "select * from [dbo].[vwInvoiceSource] Where ID = " + iID;
                ...
                if (bRes)
                {
                    ...
                    string reportPath = Server.MapPath("~\\Rpt\\" + ConfigurationManager.AppSettings["rptRAS"].ToString());
                    ...
                    string fDate = "INV-RAS-" + ds.Tables[0].Rows[0]["InvNo"].ToString();
        ...
        protected void printInvoice(string iID)
        {
            //loadRPT();            
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(comm))
                        {
                            ...
                            if (dt.Rows.Count > 0)
                            {
                                ...
                                String SQL1 = "Update tInvoiceSource " +
                                                ...
                                                "RentalPeriod = " + txtRentalPeriod.Text + ", ServicePeriod = " + txtServicePeriod.Text + ", " +
                                                "OtherArea = " + txtOtherArea.Text + ", OtherPeriod = " + txtOtherPeriod.Text + ", OtherCharge = " + txtOtherCharge.Text  + " " +
                                                "Where ID = " + iID;
                                    try
                                    {
                                        SqlConnection conn1 = new SqlConnection(Db.GetConnectionString());
        ...
        protected void btnOpenPDF_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (bRes)
                {
                    ...
                    //check file exist or not
                    string fDate = "INV-RAS-" + ddlMonthPeriod.SelectedValue.ToString() + "-" + txtYearPeriod.Text.Trim();
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName.Equals("printRecord"))
                {
                    ...
                    lblInvID.Text = kode;
                    Label1.Text = "Print RAS Invoice No INV:RAS-" + gvrow.Cells[2].Text + " | " ;
                    lblCompanyName.Text = HttpUtility.HtmlDecode(gvrow.Cells[10].Text).ToString();
                    lblSuite.Text = HttpUtility.HtmlDecode(gvrow.Cells[8].Text).ToString();
                    lblMonth.Text = ddlMonthPeriod.SelectedValue.ToString();
                    lblYear.Text = txtYearPeriod.Text;
