<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="copRAS.aspx.cs" Inherits="KMO.copRAS" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">    
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>COP: Rent & Service</h4></div>
            <div class="row">
                ...
                <ContentTemplate>                    
                    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center"
                        ...
                        <asp:ButtonField CommandName="previewRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ...
                            ButtonType="Button" Text="Preview" HeaderText ="Preview INV:RAS" 
                        ...
                        <asp:ButtonField CommandName="printRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ItemStyle-Width="50px"
                            ButtonType="Button" Text="Print" HeaderText ="Print COP:RAS" 
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center">
                            <ControlStyle CssClass="btn btn-info btn-xs"></ControlStyle>
                        </asp:ButtonField>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-5"><h4 class="modal-title" id="H21">No. COP-RAS-<asp:Label ID="lblCopNo" runat="server">xxx-xxx-xxxx</asp:Label></h4></div>
