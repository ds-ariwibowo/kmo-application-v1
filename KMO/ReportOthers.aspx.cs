...
namespace KMO
{
    public partial class ReportOthers : System.Web.UI.Page
    {
        ...
        {
            string iSql = "Select Distinct * from vwInvList_OTH_All Where Month = " + ddlMonthPeriod.SelectedValue.ToString() + " and year = " + txtYearPeriod.Text + " Order By " + iOrderBy;
        ...
        private void CreateDynamicGrid(string iOrderBy)
        {
            ...
            {
                string iQuery;
                iQuery = "Select Distinct * from vwInvList_OTH_All Where Month = " + ddlMonthPeriod.SelectedValue.ToString() + " and year = " + txtYearPeriod.Text + " Order By " + iOrderBy;
        ...
        private void printInvoice(string iID)
        {
            ...
            try
            {
                String SQL = "select Distinct * from [dbo].[vwInvList_OTH_All] Where ID = " + iID;
                    ...
                    using (SqlCommand comm = new SqlCommand(SQL, conn))
                    {
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(comm))
                        {
                            ...
                            if (dt.Rows.Count > 0)
                            {
                                ...
                                String SQL1 = "Update tInvoiceOTH " +
                                                "Set InvPrintDate = '" + iInvPrintDate.ToString() + "', InvDueDate = '" + iInvDueDate.ToString() + "' " +
                                                "Where ID = " + iID;

                                String SQL2 = "Exec spCreateInvoiceOTHNo " + ddlMonthPeriod.SelectedValue.ToString() + ", " + txtYearPeriod.Text;
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName.Equals("printRecord"))
                {
                    ...
                    Label1.Text = "Print OTH Invoice No INV:OTH-" + gvrow.Cells[2].Text + " | " + gvrow.Cells[10].Text;
                    lblInvID.Text = kode;
                    txtInvDueDate.Text = gvrow.Cells[6].Text;
                    txtInvPrintedDate.Text = gvrow.Cells[5].Text;
