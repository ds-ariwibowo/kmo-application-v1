<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="copSEC.aspx.cs" Inherits="KMO.copSEC" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">    
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>COP: Rent & Security</h4></div>
            <div class="row">
                ...
                <ContentTemplate>                    
                    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center"
                        ...
                        <asp:ButtonField CommandName="previewRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ...
                            ButtonType="Button" Text="Preview" HeaderText ="Preview INV:SEC" 
                        ...
                        <asp:ButtonField CommandName="printRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ItemStyle-Width="50px"
                            ButtonType="Button" Text="Print" HeaderText ="Print COP:SEC" 
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center">
                            <ControlStyle CssClass="btn btn-info btn-xs"></ControlStyle>
                        </asp:ButtonField>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-5"><h4 class="modal-title" id="H21">No. COP-SEC-<asp:Label ID="lblCopNo" runat="server">xxx-xxx-xxxx</asp:Label></h4></div>
                        ...
                        <div class="modal-body">                              
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-3">1.1 Rental Area</div>
                            ...
                            <div class="row">&nbsp</div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-3">1.2 Service Area</div>
                                <div class="col-xs-12 col-sm-5">
                            ...
                            <div class="row">&nbsp</div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-3">1.3 Others</div>
                                <div class="col-xs-12 col-sm-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-5">
                                    <asp:Label ID="lblPhoneLine" runat="server">xxxxxx</asp:Label> phone line x Rp.
                                    <asp:Label ID="lblPhoneLineCharge" runat="server">0</asp:Label>
                                </div>
                                <div class="col-xs-12 col-sm-2" style="text-align:right"><asp:Label ID="lblPhoneLineAmount" runat="server">xxxxxx</asp:Label></div>
                            </div>
