<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="ReportParkir.aspx.cs" Inherits="KMO.ReportParkir" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">
        <div class="row col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>Invoice PAK</h4></div>
            ...
            <asp:UpdatePanel ID="upContract" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>                    
                    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center"
                        ...
                        CssClass="GridViewStyle" Width="95%" DataKeyNames="invNo"
                        ...
                        <asp:ButtonField CommandName="printRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ...
                            ButtonType="Button" Text="Print" HeaderText ="Print INV:PAK" 
                        ...
                        <ContentTemplate>
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <strong><asp:Label ID="Label1" runat="server">Print RAS Invoice</asp:Label></strong>
                                </div>
