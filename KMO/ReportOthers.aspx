<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="ReportOthers.aspx.cs" Inherits="KMO.ReportOthers" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">
        <div class="row col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>Invoice Others</h4></div>
            <div class="row" >
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <strong><asp:Label ID="Label1" runat="server">Print OTH Invoice</asp:Label></strong>
                            </div>
