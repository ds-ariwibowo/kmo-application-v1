<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="copPLN.aspx.cs" Inherits="KMO.copPLN" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="CPH_BODY_CONTENT" runat="server">
    <div class="container">    
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="col-xs-12 col-sm-12"><h4>COP: PLN</h4></div>
            <div class="row">
                ...
                <ContentTemplate>                    
                    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center"
                        ...
                        <asp:ButtonField CommandName="previewRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ...
                            ButtonType="Button" Text="Preview" HeaderText ="Preview INV:PLN" 
                        ...
                        <asp:ButtonField CommandName="printRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ItemStyle-Width="50px"
                            ButtonType="Button" Text="Print" HeaderText ="Print COP:PLN" 
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center">
                            <ControlStyle CssClass="btn btn-info btn-xs"></ControlStyle>
                        </asp:ButtonField>
            ...
            <!--
                        ...
                        <asp:ButtonField CommandName="voidRecord" ControlStyle-CssClass="btn btn-info btn-xs"
                            ItemStyle-Width="50px"
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-5"><h4 class="modal-title" id="H21">No. COP-PLN-<asp:Label ID="lblCopPlnNo" runat="server">xxx-xxx-xxxx</asp:Label></h4></div>
                        ...
                        <div class="modal-body">                              
                            <!-- pln kwh calculation -->
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">Biaya KWh : <asp:Label ID="lblBiayaKwh" runat="server">xxxx</asp:Label></div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-5">Non AC</div>
                                <div class="col-xs-12 col-sm-6">AC</div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-1">Akhir <asp:Label ID="lblNonACAkhir" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">Awal <asp:Label ID="lblNonACAwal" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">KWh <asp:Label ID="lblNonACKwh" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-2">Total &nbsp<asp:Label ID="lblNonACTotal" runat="server">xxxxxxxx</asp:Label></div>

                                <div class="col-xs-12 col-sm-1">Akhir <asp:Label ID="lblACAkhir" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">Awal <asp:Label ID="lblACAwal" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">Indor <asp:Label ID="lblACIndoorKwh" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">Outdoor <asp:Label ID="lblACOutdoorKwh" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">KWh <asp:Label ID="lblACKwh" runat="server">xxxxxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-2">Total &nbsp<asp:Label ID="lblACTotal" runat="server">xxxxxxxx</asp:Label></div>
                            </div>                            
                            <div class="row">&nbsp</div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-1">Subtotal</div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblSubTotal" runat="server">xxx.xxx.xxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">PPJ</div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblPpj" runat="server">xxx.xxx.xxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">Admin</div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblBiayaAdmin" runat="server">xxx.xxx.xxx</asp:Label></div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-1">PPn</div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblPPn" runat="server">xxx.xxx.xxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-1">Materai</div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblMaterai" runat="server">xxx.xxx.xxx</asp:Label></div>
                            </div>
                            <div class="row">&nbsp</div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-2">Grand Total</div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblGrandTotal" runat="server">xxx.xxx.xxx</asp:Label></div>
                                <div class="col-xs-12 col-sm-2"></div><div class="col-xs-12 col-sm-3"><asp:Label ID="lblGT" runat="server" Visible="false"></asp:Label></div>
                            </div>
