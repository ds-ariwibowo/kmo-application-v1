<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="Parking.aspx.cs" Inherits="KMO.Parking" %>
<asp:Content ID="HeaderContent" ContentPlaceHolderID="CPH_HEAD" runat="server">
    <script type='text/javascript'>
        ...
        $(document).ready(function () {
            ...
            //date picker
            //var dpAdd = $('#<%=txtParkingStartPeriod.ClientID%>');
            //dpAdd.datepicker({
            //    changeMonth: true,
            //    changeYear: true,
            //    format: "dd-mm-yyyy"
                ...
                <ContentTemplate> 
                    <div class="col-xs-12 col-sm-12"><h4>Parking Service</h4></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-2" align="left">
                                <asp:TextBox ID="txtParkingStartPeriod" class="form-control input-sm" runat="server" placeholder="Start Period"></asp:TextBox>(dd-mm-yyyy)
                            </div>
                            <div class="col-xs-12 col-sm-1">Period</div>
                            <div class="col-xs-12 col-sm-1" align="left">
                                <asp:TextBox ID="txtParkingPeriod" class="form-control input-sm" runat="server" placeholder="Month(s)" 
                        ...
                        <div class="row">                            
                            ...
                            <div class="col-xs-12 col-sm-2" align="left">
                                <asp:DropDownList ID="ddlParkingType" class="form-control input-sm" runat="server">
                            ...
                            <div class="col-xs-12 col-sm-1">Parking Lot No</div>
                            <div class="col-xs-12 col-sm-1" align="left">
                                <asp:TextBox ID="txtParkingLot" class="form-control input-sm" runat="server" placeholder="Lot"></asp:TextBox></div>
                            <div class="col-xs-12 col-sm-1">Charge</div>
                            <div class="col-xs-12 col-sm-2" align="left"><asp:TextBox ID="txtParkingPrice" class="form-control input-sm" runat="server" placeholder="Charge" Width="98%" OnKeyPress="return isNumberKey(this, event);"></asp:TextBox></div>
                            <div class="col-xs-12 col-sm-1">License No</div>
                            <div class="col-xs-12 col-sm-2" align="left"><asp:TextBox ID="txtParkingLicenseNo" class="form-control input-sm" runat="server" placeholder="LicenseNo" Width="90%"></asp:TextBox></div>
                        </div>
                        <div class="row">&nbsp</div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-10">&nbsp</div>
                            ...
                            <asp:UpdatePanel ID="upParking" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>                                                
                                    <asp:GridView ID="GridView2" runat="server" HorizontalAlign="Center"
                                        ...
                                        <asp:BoundField DataField="LotNo" HeaderText="Parking Lot No"/>
                                        <asp:BoundField DataField="PeriodDate" HeaderText="Start Period" ItemStyle-HorizontalAlign="Center"/>
                                        <asp:BoundField DataField="Period" HeaderText="Period"/>                                        
                                        <asp:BoundField DataField="PeriodMY" HeaderText=" "/>
                                        <asp:BoundField DataField="LicenseNo" HeaderText="License No"/>
                                        <asp:BoundField DataField="Charge" HeaderText="Charge" ItemStyle-HorizontalAlign="Right" />
                                    </Columns>
