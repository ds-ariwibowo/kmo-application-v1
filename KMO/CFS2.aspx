<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Site.Master" AutoEventWireup="true" CodeBehind="CFS2.aspx.cs" Inherits="KMO.Setup.CFS2" %>
    ...
    <div class="row col-xs-12 col-sm-12">        
        ...
        <div class="panel panel-default" style="padding: 10px; margin: 10px">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#cfsLOO" aria-controls="cfsLOO" role="tab" data-toggle="tab">LOO</a></li>

                <li><a href="#cfs" aria-controls="cfs" role="tab" data-toggle="tab">Client Fact Sheet</a></li>
            </ul>

            <!-- Tab panes -->
            <asp:HiddenField ID="TabName" runat="server" />
            <div class="tab-content" style="padding-top: 20px">
                <div role="tabpanel" class="tab-pane" id="cfsLOO">
                    ...
                    <div style="border:1px solid black;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-10">
                                <table border="1 solid black">
                                    <tr>
                                    <th colspan="30">Required Telephone Lines</th>
                                    </tr>
                                    <tr><th colspan="30"><asp:RadioButton ID="rbTL0" runat="server" GroupName="rTL" /> None</th></tr>
                                    <tr>
                                    <td>1</td>
                                    <td>2</td>
                                    <td>3</td>
